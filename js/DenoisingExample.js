...
var DenoisingExample = (function () {
    function DenoisingExample() {
    }
    DenoisingExample.main = function (args) {
        try {
            var filename = args[0];
...
DenoisingExample["__class"] = "DenoisingExample";
DenoisingExample.main(null);
