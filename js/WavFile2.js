...
var WavFile2 = (function () {
    function WavFile2() {
        ...
        this.buffer = (function (s) { var a = []; while (s-- > 0)
            a.push(0); return a; })(WavFile2.BUFFER_SIZE);
    }
    WavFile2.prototype.getNumChannels = function () {
        return this.numChannels;
    };
    WavFile2.prototype.getNumFrames = function () {
        return this.numFrames;
    };
    WavFile2.prototype.getFramesRemaining = function () {
        return this.numFrames - this.frameCounter;
    };
    WavFile2.prototype.getSampleRate = function () {
        return this.sampleRate;
    };
    WavFile2.prototype.getValidBits = function () {
        return this.validBits;
    };
    WavFile2.newWavFile = function (file, numChannels, numFrames, validBits, sampleRate) {
        var wavFile = new WavFile2();
        wavFile.file = file;
    ...
    WavFile2.openWavFile = function (file) {
        var wavFile = new WavFile2();
        wavFile.file = file;
        ...
        var riffChunkID = WavFile2.getLE(wavFile.buffer, 0, 4);
        var chunkSize = WavFile2.getLE(wavFile.buffer, 4, 4);
        var riffTypeID = WavFile2.getLE(wavFile.buffer, 8, 4);
        if (riffChunkID !== WavFile2.RIFF_CHUNK_ID)
            throw new WavFileException("Invalid Wav Header data, incorrect riff chunk ID");
        if (riffTypeID !== WavFile2.RIFF_TYPE_ID)
        ...
        while ((true)) {
            ...
            var chunkID = WavFile2.getLE(wavFile.buffer, 0, 4);
            ...
            if (chunkID === WavFile2.FMT_CHUNK_ID) {
                ...
                var compressionCode = (WavFile2.getLE(wavFile.buffer, 0, 2) | 0);
                if (compressionCode !== 1)
                    throw new WavFileException("Compression Code " + compressionCode + " not supported");
                wavFile.numChannels = (WavFile2.getLE(wavFile.buffer, 2, 2) | 0);
                wavFile.sampleRate = WavFile2.getLE(wavFile.buffer, 4, 4);
                wavFile.blockAlign = (WavFile2.getLE(wavFile.buffer, 12, 2) | 0);
                wavFile.validBits = (WavFile2.getLE(wavFile.buffer, 14, 2) | 0);
    ...
    WavFile2.getLE = function (buffer, pos, numBytes) {
        numBytes--;
        pos += numBytes;
    ...
    WavFile2.putLE = function (val, buffer, pos, numBytes) {
        for (var b = 0; b < numBytes; b++) {
    ...
    WavFile2.prototype.writeSample = function (val) {
    ...
    WavFile2.prototype.readSample = function () {
        var val = 0;
        for (var b = 0; b < this.bytesPerSample; b++) {
            if (this.bufferPointer === this.bytesRead) {
                var read = this.iStream.read(this.buffer, 0, WavFile2.BUFFER_SIZE);
                if (read === -1)
    ...
    WavFile2.prototype.readFrames$int_A$int = function (sampleBuffer, numFramesToRead) {
        return this.readFrames$int_A$int$int(sampleBuffer, 0, numFramesToRead);
    };
    WavFile2.prototype.readFrames$int_A$int$int = function (sampleBuffer, offset, numFramesToRead) {
        if (this.ioState !== WavFile2.IOState.READING)
    ...
    WavFile2.prototype.readFrames = function (sampleBuffer, offset, numFramesToRead) {
    ...
    WavFile2.prototype.readFrames$int_A_A$int = function (sampleBuffer, numFramesToRead) {
        return this.readFrames$int_A_A$int$int(sampleBuffer, 0, numFramesToRead);
    };
    WavFile2.prototype.readFrames$int_A_A$int$int = function (sampleBuffer, offset, numFramesToRead) {
        if (this.ioState !== WavFile2.IOState.READING)
            throw Object.defineProperty(new Error("Cannot read from WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToRead; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.writeFrames$int_A$int = function (sampleBuffer, numFramesToWrite) {
        return this.writeFrames$int_A$int$int(sampleBuffer, 0, numFramesToWrite);
    };
    WavFile2.prototype.writeFrames$int_A$int$int = function (sampleBuffer, offset, numFramesToWrite) {
        if (this.ioState !== WavFile2.IOState.WRITING)
    ...
    WavFile2.prototype.writeFrames = function (sampleBuffer, offset, numFramesToWrite) {
    ...
    WavFile2.prototype.writeFrames$int_A_A$int = function (sampleBuffer, numFramesToWrite) {
        return this.writeFrames$int_A_A$int$int(sampleBuffer, 0, numFramesToWrite);
    };
    WavFile2.prototype.writeFrames$int_A_A$int$int = function (sampleBuffer, offset, numFramesToWrite) {
        if (this.ioState !== WavFile2.IOState.WRITING)
            throw Object.defineProperty(new Error("Cannot write to WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToWrite; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.readFrames$long_A$int = function (sampleBuffer, numFramesToRead) {
        return this.readFrames$long_A$int$int(sampleBuffer, 0, numFramesToRead);
    };
    WavFile2.prototype.readFrames$long_A$int$int = function (sampleBuffer, offset, numFramesToRead) {
        if (this.ioState !== WavFile2.IOState.READING)
            throw Object.defineProperty(new Error("Cannot read from WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToRead; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.readFrames$long_A_A$int = function (sampleBuffer, numFramesToRead) {
        return this.readFrames$long_A_A$int$int(sampleBuffer, 0, numFramesToRead);
    };
    WavFile2.prototype.readFrames$long_A_A$int$int = function (sampleBuffer, offset, numFramesToRead) {
        if (this.ioState !== WavFile2.IOState.READING)
            throw Object.defineProperty(new Error("Cannot read from WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToRead; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.writeFrames$long_A$int = function (sampleBuffer, numFramesToWrite) {
        return this.writeFrames$long_A$int$int(sampleBuffer, 0, numFramesToWrite);
    };
    WavFile2.prototype.writeFrames$long_A$int$int = function (sampleBuffer, offset, numFramesToWrite) {
        if (this.ioState !== WavFile2.IOState.WRITING)
            throw Object.defineProperty(new Error("Cannot write to WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToWrite; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.writeFrames$long_A_A$int = function (sampleBuffer, numFramesToWrite) {
        return this.writeFrames$long_A_A$int$int(sampleBuffer, 0, numFramesToWrite);
    };
    WavFile2.prototype.writeFrames$long_A_A$int$int = function (sampleBuffer, offset, numFramesToWrite) {
        if (this.ioState !== WavFile2.IOState.WRITING)
            throw Object.defineProperty(new Error("Cannot write to WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToWrite; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.readFrames$double_A$int = function (sampleBuffer, numFramesToRead) {
        return this.readFrames$double_A$int$int(sampleBuffer, 0, numFramesToRead);
    };
    WavFile2.prototype.readFrames$double_A$int$int = function (sampleBuffer, offset, numFramesToRead) {
        if (this.ioState !== WavFile2.IOState.READING)
            throw Object.defineProperty(new Error("Cannot read from WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToRead; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.readFrames$double_A_A$int = function (sampleBuffer, numFramesToRead) {
        return this.readFrames$double_A_A$int$int(sampleBuffer, 0, numFramesToRead);
    };
    WavFile2.prototype.readFrames$double_A_A$int$int = function (sampleBuffer, offset, numFramesToRead) {
        if (this.ioState !== WavFile2.IOState.READING)
            throw Object.defineProperty(new Error("Cannot read from WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToRead; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.writeFrames$double_A$int = function (sampleBuffer, numFramesToWrite) {
        return this.writeFrames$double_A$int$int(sampleBuffer, 0, numFramesToWrite);
    };
    WavFile2.prototype.writeFrames$double_A$int$int = function (sampleBuffer, offset, numFramesToWrite) {
        if (this.ioState !== WavFile2.IOState.WRITING)
            throw Object.defineProperty(new Error("Cannot write to WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToWrite; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.writeFrames$double_A_A$int = function (sampleBuffer, numFramesToWrite) {
        return this.writeFrames$double_A_A$int$int(sampleBuffer, 0, numFramesToWrite);
    };
    WavFile2.prototype.writeFrames$double_A_A$int$int = function (sampleBuffer, offset, numFramesToWrite) {
        if (this.ioState !== WavFile2.IOState.WRITING)
            throw Object.defineProperty(new Error("Cannot write to WavFile instance"), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.io.IOException', 'java.lang.Object', 'java.lang.Exception'] });
        for (var f = 0; f < numFramesToWrite; f++) {
            if (this.frameCounter === this.numFrames)
    ...
    WavFile2.prototype.close = function () {
    ...
    WavFile2.prototype.display$ = function () {
        this.display$java_io_PrintStream(java.lang.System.out);
    };
    WavFile2.prototype.display$java_io_PrintStream = function (out) {
        out.printf("File: %s\n", this.file);
    ...
    WavFile2.prototype.display = function (out) {
    ...
    WavFile2.main = function (args) {
        if (args.length < 1) {
            console.error("Must supply filename");
            java.lang.System.exit(1);
        }
        try {
            for (var index122 = 0; index122 < args.length; index122++) {
                var filename = args[index122];
                {
                    var readWavFile = WavFile2.openWavFile(new java.io.File(filename));
                    readWavFile.display();
                    ...
                    var writeWavFile_1 = WavFile2.newWavFile(new java.io.File("out.wav"), numChannels, numFrames, validBits, sampleRate);
                    var BUF_SIZE = 5001;
            ...
            var writeWavFile = WavFile2.newWavFile(new java.io.File("out2.wav"), 1, 10, 23, 44100);
...
WavFile2.sourceDataLine = null;
WavFile2.BUFFER_SIZE = 4096;
WavFile2.FMT_CHUNK_ID = 544501094;
WavFile2.DATA_CHUNK_ID = 1635017060;
WavFile2.RIFF_CHUNK_ID = 1179011410;
WavFile2.RIFF_TYPE_ID = 1163280727;
...
(function (WavFile2) {
    ...
    })(IOState = WavFile2.IOState || (WavFile2.IOState = {}));
})(WavFile2 || (WavFile2 = {}));
WavFile2.main(null);
